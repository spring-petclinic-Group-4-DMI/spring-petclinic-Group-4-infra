...
│       ├── ecr/                  # ECR repos (per service), lifecycle policies
...
│   └── argocd/                   # ArgoCD install values + Application CRDs
│       ├── install/
│       └── applications/dev/     # 8 Applications (one per service)
│
├── helm/                            # Helm Charts
...
| CD | ArgoCD | GitOps — watches Git, auto-sync to dev |
